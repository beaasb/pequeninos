...
const SpoilerBook = () => {
  const includes = [
    ...
    { image: "https://github.com/beaasb/pequeninos/blob/main/images/mNUXXJo.webp", alt: "Sessões Temáticas", title: "3 Sessões Temáticas" },
  ...
  const mockupImg = "images/GD6dHoU%20-%20Imgur.webp";

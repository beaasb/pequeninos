...
const SpoilerBook = () => {
  const includes = [
    ...
    { image: "https://raw.githubusercontent.com/beaasb/pequeninos/refs/heads/main/images/8ulITpE.webp", alt: "Certificado de Conclusão", title: "Certificado de Conclusão" },
  ];

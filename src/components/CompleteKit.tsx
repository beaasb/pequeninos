      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div
            ...
            <p className="text-center font-semibold text-lg text-gray-500 mb-10">ou 2x de R$7,22 no cartão</p>
            <div className="text-center">
              <a
                href="https://pay.cakto.com.br/37vfpfn_513204"
                onClick={handleLivroClick}
                className="nline-block bg-green-600 text-white font-bold px-10 py-5 rounded-xl text-lg rounded-md hover:bg-green-700 transition mb-8 -mt-10" 
              >               

    ...
    <section className="py-16 px-4 bg-gradient-to-br from-indigo-50 to-blue-50">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl md:text-3xl font-bold text-black mb-12">
          <span className="bg-yellow-400 py-3 px-12 rounded block w-full md:max-w-3xl mx-auto">VOCÊ VAI RECEBER AO ADQUIRIR SEU PRODUTO</span>
        </h2>
          ...
          >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-5 w-full md:w-5/12">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-bold text-gray-800 mb-3 bg-yellow-400">{item.title}</h3>
                <h4 className="text-4xl font-bold text-black font-serif mb-2">{item.subtitle}</h4>
                <h5 className="text-lg font-bold text-pink-400 mb-4">{item.description}</h5>
                ...
                <h4 className="text-center text-xl font-bold text-gray-800 mt-6">E muito mais...</h4>
              </div>
            </div>
          </div>
        ))}
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-10">
          E NÃO PARA POR AÍ... 
          <span className="block mt-7">TEM MAIS!</span>
        </h2>
